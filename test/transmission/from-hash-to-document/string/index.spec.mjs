...
import transformStringSchema from '#transmission/transmission/from-hash-to-document/string'

describe('#transmission/transmission/from-hash-to-document/string', () => {
  it('is a function', () => {
