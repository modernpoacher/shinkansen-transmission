...
/**
 *  `transformArraySchema` is an entry point to `fromHashToDocument`
 *
 *  The `uri` and `index` values are destructured from an object in the third position of the function arguments
 *
