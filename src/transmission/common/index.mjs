 ...
 *
 *  @typedef {TransmissionTypes.MetaType} MetaType
 *
 *  @typedef {TransmissionTypes.StringMetaType} StringMetaType
 *  @typedef {TransmissionTypes.NumberMetaType} NumberMetaType
 *  @typedef {TransmissionTypes.ArrayMetaType} ArrayMetaType
 *  @typedef {TransmissionTypes.ObjectMetaType} ObjectMetaType
 *  @typedef {TransmissionTypes.BooleanMetaType} BooleanMetaType
 *  @typedef {TransmissionTypes.NullMetaType} NullMetaType
 *
 *  @typedef {TransmissionTypes.ElementsType} ElementsType

 *  @typedef {TransmissionTypes.StringElementsType} StringElementsType
 *  @typedef {TransmissionTypes.NumberElementsType} NumberElementsType
 *  @typedef {TransmissionTypes.ArrayElementsType} ArrayElementsType
 *  @typedef {TransmissionTypes.ObjectElementsType} ObjectElementsType
 *  @typedef {TransmissionTypes.BooleanElementsType} BooleanElementsType
 *  @typedef {TransmissionTypes.NullElementsType} NullElementsType
 *
 ...
 *  @param {string} [uri]
 *  @returns {StringMetaType | NumberMetaType | ArrayMetaType | ObjectMetaType | BooleanMetaType | NullMetaType | Record<string, never>}
 */
 ...
 *  @param {ParamsType} [params]
 *  @param {string} [uri]
 *  @returns {StringElementsType | NumberElementsType | ArrayElementsType | ObjectElementsType | BooleanElementsType | NullElementsType | Record<string, never>}
 */
