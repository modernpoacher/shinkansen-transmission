...
type StringMetaType = TransmissionTypes.StringMetaType
type NumberMetaType = TransmissionTypes.NumberMetaType
type ArrayMetaType = TransmissionTypes.ArrayMetaType
type ObjectMetaType = TransmissionTypes.ObjectMetaType
type BooleanMetaType = TransmissionTypes.BooleanMetaType
type NullMetaType = TransmissionTypes.NullMetaType

type StringElementsType = TransmissionTypes.StringElementsType
type NumberElementsType = TransmissionTypes.NumberElementsType
type ArrayElementsType = TransmissionTypes.ArrayElementsType
type ObjectElementsType = TransmissionTypes.ObjectElementsType
type BooleanElementsType = TransmissionTypes.BooleanElementsType
type NullElementsType = TransmissionTypes.NullElementsType
